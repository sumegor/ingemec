          ...
          if column.association
            ...
            # final ultimate fallback: use rails' generic input method
              ...
              input(:record, column.name, options)
								input(:record, column.name, options.merge(column.options)) #PATCH AGREGADO - desde http://code.google.com/p/activescaffold/issues/detail?id=507 - Héctor Fabio Spitia
            end
          end
        end
      end
